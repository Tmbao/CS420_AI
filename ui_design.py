...
#
# Created: Fri Apr 22 07:54:01 2016
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(20, 10, 271, 346))
        self.layoutWidget.setObjectName(_fromUtf8("layoutWidget"))
        self.verticalLayout = QtGui.QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setMargin(0)
        self.verticalLayout.setObjectName(_fromUtf8("verticalLayout"))
        self.label = QtGui.QLabel(self.layoutWidget)
        self.label.setMinimumSize(QtCore.QSize(269, 74))
        self.label.setMaximumSize(QtCore.QSize(269, 74))
        ...
        self.lineEditHeuristicFile = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lineEditEdgeFile = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lineEditSrc = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lineEditTarget = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lineEditAlgorithm = QtGui.QLineEdit(self.layoutWidget)
        ...
        self.lineEditImageFile = QtGui.QLineEdit(self.layoutWidget)
